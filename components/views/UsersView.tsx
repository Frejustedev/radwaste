            ...
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="border-b border-subtle text-xs uppercase tracking-wide text-muted">
                  <th className="px-4 py-3 font-bold">Nom &amp; e-mail</th>
                  <th className="px-4 py-3 font-bold">Rôle</th>
                  <th className="px-4 py-3 font-bold">Droits</th>
              ...
              <tbody>
                {users.map((u) => {
                  ...
                  return (
                    <tr key={u.id} className="border-b border-subtle last:border-0 align-top">
                      ...
                      <td className="px-4 py-3">
                        {permissions.length === 0 ? (
                          <span className="text-xs text-faint">Aucun droit</span>
                        ) : (
